(()=>{
  ...
  function ensureStyles(){
    ...
    s.textContent=`
      #cfCalMini [data-date]>.cf-cal-weather-row{display:flex;align-items:center;justify-content:flex-start;min-height:30px;margin:5px -2px 2px;padding:0 2px;border-top:1px solid #eceee8}
      .cf-cal-weather-btn{width:100%;border:0;background:transparent;padding:6px 2px 4px;display:flex;align-items:center;justify-content:flex-start;gap:5px;color:#454945;cursor:pointer;text-align:left;font:800 10px/1 system-ui,-apple-system,sans-serif}
      ...
      .cf-cal-weather-loading{font:700 9px/1 system-ui,-apple-system,sans-serif;color:#9a9e99;padding:7px 2px}
