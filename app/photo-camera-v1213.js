...
// CleanFleet v1.30.63 — bootstrap selektywnej warstwy ikon i odświeżenie Service Workera.
(()=>{
  'use strict';
  ...
  const start=()=>{
    ...
    if(!document.querySelector('link[href*="/app/glass-icons.css"]')){
      ...
      link.rel='stylesheet';link.href='/app/glass-icons.css?v=13063';
      document.head.appendChild(link);
    }
    if(!document.querySelector('script[src*="/app/glass-icons.js"]')){
      const script=document.createElement('script');
      script.src='/app/glass-icons.js?v=13063';script.defer=true;
      document.body.appendChild(script);
    }
    if('serviceWorker' in navigator){
      navigator.serviceWorker.register('/app/sw.js?v=20260922-13063',{updateViaCache:'none'})
