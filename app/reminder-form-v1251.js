(()=>{
  ...
  function style(){
    ...
    const s=document.createElement('style');s.id='cfReminderRange1251Style';s.textContent=`
      ...
      .cf-rem-range-grid{display:grid;grid-template-columns:1fr 1fr;gap:10px 12px}.cf-rem-range-span2{grid-column:span 2}.cf-rem-range-field span{display:block;font-size:11px;color:#666f69;margin-bottom:5px;font-weight:700}.cf-rem-range-field input,.cf-rem-range-field select,.cf-rem-range-field textarea{width:100%;border:1px solid #d3d9d5;border-radius:10px;background:#fff;color:#171914;padding:10px 11px;min-height:42px}.cf-rem-range-field textarea{min-height:88px;resize:vertical}
      .cf-rem-range-dates{display:grid;grid-template-columns:1fr 1fr;gap:10px}.cf-rem-range-box{background:#fff;border:1px solid #dde2de;border-radius:12px;padding:10px}.cf-rem-range-box b{display:block;font-size:11px;margin-bottom:8px}.cf-rem-range-box .row{display:grid;grid-template-columns:1.2fr .8fr;gap:8px}
