// CleanFleet v1.30.27 — approved-and-paid filter release.
...
self.addEventListener('fetch', event => {
  ...
  event.respondWith((async () => {
    ...
    html = html.replace(/Wersja aplikacji:\s*v\d+\.\d+\.\d+(?:\s*beta)?/g, 'Wersja aplikacji: v1.30.27');
...
<!-- CF_WEATHER_SLOT_END -->`;
    ...
    const injectedScripts = '<script src="/app/weather-v6.js?v=20260916-1"></script>\n' +
      ...
      '<script src="/app/operations-v1200.js?v=20260919-13027"></script>\n' +
      '<script src="/app/photo-local-v1240.js?v=20260919-13027"></script>\n' +
      '<script src="/app/photo-local-ui-v1232.js?v=20260919-13027"></script>\n' +
      '<script src="/app/photo-camera-v1213.js?v=20260919-13027"></script>\n' +
      ...
      '<script src="/app/admin-dashboard-v1270.js?v=20260919-13027"></script>';
